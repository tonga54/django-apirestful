    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trabajador', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trabajador_servicio', to='usuarios.Trabajador')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de creacion')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Fecha de modificacion')),
                ('atencionClienteEmpleadoLocal', models.ManyToManyField(related_name='tb_cliente_atencion_cliente_empleado_local', through='usuarios.AtencionClienteEmpleadoLocal', to='locales.Local')),
                ('atencionClienteTrabajador', models.ManyToManyField(related_name='atencion_cliente_trabajador', through='usuarios.AtencionClienteTrabajador', to='usuarios.Trabajador')),
            ],
            options={
